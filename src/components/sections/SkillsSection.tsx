    ...
    return (
      ...
      ">
            ...
            <motion.div variants={item} className="flex flex-col md:flex-row gap-8 max-w-5xl mx-auto">
                ...
                <div className="bg-darkBg rounded-lg p-6 shadow-md flex-1">
                    <h3 className="text-xl font-semibold text-purple-300 mb-4 flex items-center gap-2">
                        <FaCogs /> Core Development Stack
                    </h3>
                    <div className="flex flex-wrap gap-3 text-sm">
                        <div className="bg-darkBgAlt px-3 py-1 rounded flex items-center gap-2">
                ...
                <div className="bg-darkBg rounded-lg p-6 shadow-md flex-1">
                    ...
                    <div className="flex flex-wrap gap-3 text-sm">
                        ...
                        <div className="bg-darkBgAlt px-3 py-1 rounded flex items-center gap-1">
            ...
            <motion.div variants={item} className="mt-10 bg-darkBg p-6 rounded-lg shadow-md max-w-3xl mx-auto">
